...
function MediaCard({ step, mobile }) {
  return (
    <div className={clsx('relative rounded-sm overflow-hidden border border-white/8 group', mobile ? 'aspect-video' : 'aspect-[4/3]')}>
      <img src={step.media} alt={step.title} width="1600" height="1200" className="w-full h-full object-cover opacity-60 group-hover:opacity-80 group-hover:scale-[1.03] transition-all duration-700" loading="lazy" decoding="async" />
